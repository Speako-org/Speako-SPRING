...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(JwtProperties jwtProperties, RedisUtil redisUtil, UserRepository userRepository) {
    ...
    public long getExpiration(String token) {
        try {
            Claims claims = Jwts.parserBuilder()
                    ...
                    .parseClaimsJws(token)
                    .getBody();
            return (claims.getExpiration().getTime() - System.currentTimeMillis()) / 1000; // 초 단위로 변환
