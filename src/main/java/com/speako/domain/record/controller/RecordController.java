...
public class RecordController {
    ...
    public CustomResponse<RecordUploadResDTO> getPresignedUrl(
        ...
        return CustomResponse.onSuccess(recordCommandService.createPresignedUrl(customUserDetails.getId(), recordId, fileName));
    }
    ...
    public CustomResponse<String> completeUploadAndStartStt(
        ...
        recordCommandService.completeUploadAndStartStt(customUserDetails.getId(), recordId, recordS3Path, startTime, endTime);
